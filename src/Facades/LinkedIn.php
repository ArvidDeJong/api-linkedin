 ...
 * @method static string authorizationUrl(string $state, ?list<string> $scopes = null)
 * @method static \Darvis\ApiLinkedin\Models\LinkedInAccount connectFromCode(string $code, ?list<string> $requestedScopes = null)
